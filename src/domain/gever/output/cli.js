...
var makeRequest = function (url, body, headers, agent) {
...
var $ = function (doc, ns, qs, index) {
  ...
  if (elements.length > 1 && typeof index === "undefined") {
    ...
    throw new Error(
      "Too many elements for " + ns + ":" + qs + ", please add an index"
    );
  }
  if (!elements.length) {
...
var canonicalizeXML = function (tree) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [
        2 /*return*/,
...
var digestTimestampNode = function (timestampNode) {
  return __awaiter(void 0, void 0, void 0, function () {
    var timestampCanonical, hash, digestValue;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, canonicalizeXML(timestampNode)];
        case 1:
...
var digestSignedInfoNode = function (signedInfoNode, binaryToken) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var makeRequest2 = function (resp1Str) {
  return __awaiter(void 0, void 0, void 0, function () {
    var resp1,
      doc,
      samlAssertion,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          binaryTokenB64 = $(resp1, ns.wst, "BinarySecret", 1).textContent;
          ...
          security.insertBefore(
            samlAssertion,
            $(security, ns.sig, "Signature")
          );
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            digestSignedInfoNode(signedInfoNode, binaryToken),
          ];
        case 2:
          ...
          return [
            4 /*yield*/,
            makeRequest(bindings.rpsts, req2, {
...
var makeRequest3 = function (resp2Str, docId) {
  return __awaiter(void 0, void 0, void 0, function () {
    var resp2,
      doc,
      samlAssertion,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            makeRequest(bindings.service, req3, {
              "Content-Type": "application/soap+xml; charset=utf-8",
            }),
          ];
        case 1:
...
var makeDownloadRequest = function (docId) {
  return __awaiter(void 0, void 0, void 0, function () {
