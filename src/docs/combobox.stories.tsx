...
import {
  ComboboxMulti as ComboboxMultiComponent,
  Combobox as ComboboxComponent,
} from "../components/combobox";
import {
  MunicipalitiesCombobox as MunicipalitiesComboboxComponent,
  OperatorsCombobox as OperatorsComboboxComponent,
...
export const MunicipalitiesCombobox = () => {
  ...
  return (
    <>
      <MunicipalitiesComboboxComponent
