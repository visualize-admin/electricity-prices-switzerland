...
import { ColumnsGrouped as ColumnsGroupedComponent } from "../components/charts-generic/columns/columns-grouped";
import { GroupedColumnChart } from "../components/charts-generic/columns/columns-grouped-state";
import { Columns as ColumnsComponent } from "../components/charts-generic/columns/columns-simple";
  ...
  >
    <ChartContainer>
      <ChartSvg>
        ...
        <ColumnsComponent /> <AxisWidthBandDomain />
        <InteractionColumns />
      </ChartSvg>
      <Tooltip type="single" />
    </ChartContainer>
...
export const ColumnsGrouped = () => (
  ...
  >
    <ChartContainer>
      <ChartSvg>
        <AxisHeightLinear /> <AxisWidthBand />
        <ColumnsGroupedComponent /> <AxisWidthBandDomain />
        <InteractionColumns />
      </ChartSvg>
